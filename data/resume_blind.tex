\begin{resume}
   ...
   \item 第一作者. 2025 IEEE International Symposium on Parallel and Distributed Processing with Applications. MMoH: Efficient Training of Multimodal Large Language Models on Heterogeneous Clusters, 2025: 990-997. (CCF 推荐 C 类会议收录)
   \end{enumerate}
 \end{resume}
